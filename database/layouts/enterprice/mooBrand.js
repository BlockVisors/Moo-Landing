module.exports = {
    BrandData: [
        {
            img: '/assets/images/graphics/ethlogo.png'
        },
        {
            img: '/assets/images/graphics/uniswap.png'
        },
        {
            img: '/assets/images/graphics/0x.png'
        },
        {
            img: '/assets/images/graphics/opensea.png'
        },
        {
            img: '/assets/images/graphics/aragon.png'
        },
        {
            img: '/assets/images/graphics/wallett-connect.svg'
        },
    ],
